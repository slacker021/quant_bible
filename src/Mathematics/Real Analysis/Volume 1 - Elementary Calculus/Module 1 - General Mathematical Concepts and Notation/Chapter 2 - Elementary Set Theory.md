...
$$
\begin{gather}
\textbf{Definition 1: The Concept of a Set} \\[5mm]
...
$$
\begin{gather}
\textbf{Definition 2: Set Union} \\[5mm]
...
\textbf{Definition 3: Set Intersection} \\[5mm]
...
\textbf{Definition 4: Set Difference} \\[5mm]
...
$$
\begin{gather}
\textbf{Definition 5: Set Complement} \\[5mm]
...
$$
\begin{gather}
\textbf{Axiom 1: The Principle of Extensionality} \\[5mm]
...
\textbf{Axiom 2: The Principle of Separation: } \\[5mm]
...
$$
\begin{gather}
\textbf{Proposition 1: Empty Set as a Subset of a Set} \\[5mm]
...
$$
\begin{gather}
\textbf{Axiom 3: Union of a Set} \\[5mm]
...
$$
\begin{gather}
\textbf{Axiom 4: Principle of Pairing} \\[5mm]
...
$$
\begin{gather}
\textbf{Definition 6: Successor Set} \\[5mm]
...
$$
\begin{gather}
\textbf{Definition 7: Inductive Set} \\[5mm]
...
$$
\begin{gather}
\textbf{Axiom 6: Principle of Infinity} \\[5mm]
\text{Inductive sets exists.}
\end{gather}
$$ 
$$
\begin{gather}
\textbf{Axiom 7: Principle of Replacement}  \\[5mm]
...
$$
\begin{gather}
\textbf{Axiom 8: Principle of Choice} \\[5mm]
...
$$
\begin{gather}
\textbf{Proposition 2: de Morgan's Law of Set Complements} \\[5mm]
...
$$
\begin{gather}
\textbf{Proposition 3: Distributive Laws of Intersection and Union: } \\[5mm]
...
$$
\begin{gather}
\textbf{Lemma 1: Elementary Lemma of Set Complementation}  \\[5mm]
\text{For any subsets } A,B,C \subset M:  \\[2.5mm]
