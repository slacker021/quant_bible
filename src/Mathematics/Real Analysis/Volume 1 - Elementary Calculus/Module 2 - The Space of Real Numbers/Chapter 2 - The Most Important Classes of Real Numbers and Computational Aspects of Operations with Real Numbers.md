...
Having established the axiomatic foundation of the real numbers, we now turn to identifying specific, fundamental subsets within $\mathbb{R}$. These subsets are crucial for theoretical development and practical computation.

## The Natural Numbers and the Principle of Mathematical Induction

$$\begin{gather} \textbf{Definition 1: Inductive Set} \\ \text{A set } X \subset \mathbb{R} \text{ is inductive if for each number } x \in X, \text{ it also contains } x + 1. \end{gather}$$$$\begin{gather} \textbf{Definition 2: The Set of Natural Numbers} \\ \text{The set of natural numbers, denoted } \mathbb{N}, \text{ is the smallest inductive set containing 1.} \\ \text{It is the intersection of all inductive sets that contain 1.} \end{gather}$$

This definition leads directly to a vital proof technique.

$$\begin{gather} \textbf{Theorem 1: The Principle of Mathematical Induction} \\ \text{If a subset } E \subset \mathbb{N} \text{ satisfies } 1 \in E \text{ and } (x \in E \implies (x + 1) \in E), \text{ then } E = \mathbb{N}. \end{gather}$$

Using induction, we establish core properties of $\mathbb{N}$:

$$\begin{gather} \textbf{Proposition 1: Properties of Natural Numbers} \\ \text{1. The sum and product of natural numbers are natural numbers.} \\ \text{2. } (n \in \mathbb{N}) \wedge (n \ne 1) \implies ((n - 1) \in \mathbb{N}). \\ \text{3. For any } n \in \mathbb{N}, \text{ the set } \{x \in \mathbb{N} \mid n < x\} \text{ contains a minimal element:} \\ \min\{x \in \mathbb{N} \mid n < x\} = n + 1. \\ \text{4. } (m, n \in \mathbb{N}) \wedge (n < m) \implies (n + 1 \le m). \\ \text{5. } n + 1 \text{ is the immediate successor of } n \text{ in } \mathbb{N} \text{ (no natural numbers lie between them).} \\ \text{6. If } n \ne 1, n - 1 \text{ is the immediate predecessor of } n \text{ in } \mathbb{N}. \\ \text{7. Any nonempty subset of } \mathbb{N} \text{ contains a minimal element.} \end{gather}$$
