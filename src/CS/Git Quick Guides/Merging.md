...
>Before using `git commit`, the user must know what branch they are on. Once the merge is performed, Git takes all changes from the target branch onto the current branch. 
